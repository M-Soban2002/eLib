...
import 'package:e_lib/service/apiclassbook.dart';
...
class _ELibState extends State<ELib> {
  ...
  final ApiServiceBook apiServiceBook = ApiServiceBook('your_base_url_here');
  ...
  Future<void> _fetchBooks() async {
    try {
      final fetchedBooks = await apiServiceBook.getAllBooks(1, 10);
      setState(() {
        books = fetchedBooks;
      });
    } catch (error) {
